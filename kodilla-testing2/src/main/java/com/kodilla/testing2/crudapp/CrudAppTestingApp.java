...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_SELECT_ALTER = "//div[contains(@class, \"tasks-container\")]/form/div/fieldset/select[1]";
    ...
    public static void main(String[] args) {
        ...
        WebElement selectCombo = driver.findElement(By.xpath(XPATH_SELECT_ALTER));
